...
class TicTacToeGame {
    ...
    /**
     * Concurrent hash map is used because it can be accessed safely by multiple threads
     */
    ...
    init {
        /**
         * Whenver the state changes, broadcast it to all players
         */
    ...
    fun finishTurn(player: Char, x: Int, y: Int) {
        // if the space is occupied or there is already a winner, return
